...
### - Energy modelers typically assume equal usage between CVs & BEVs

--

### reaching mass PEV adoption depends on how well the technology per-
forms as a direct substitute for CVs (Xing et al., 2021). 

--

### mate of PEV mileage could become important for government budget planning as scholars
are increasingly calling to replace the gasoline tax with a vehicle mileage tax (Metcalf et al.,
2022; Zhao and Mattauch, 2022; Davis and Sallee, 2020)
